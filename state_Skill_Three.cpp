...
void state_Skill_Three::onButtonW(player* Player)
{
}

void state_Skill_Three::onButtonS(player* Player)
{
}

void state_Skill_Three::onButtonA(player* Player)
{
}

void state_Skill_Three::onButtonD(player* Player)
{
}

void state_Skill_Three::offButtonW(player * Player)
{
}

void state_Skill_Three::offButtonS(player * Player)
{
}

void state_Skill_Three::offButtonA(player * Player)
{
}

void state_Skill_Three::offButtonD(player * Player)
{
}

void state_Skill_Three::onButtonQ(player* Player)
{
}
...
void state_Skill_Three::onButtonSpace(player* Player)
{
}

void state_Skill_Three::onButtonLB(player* Player)
{
}

void state_Skill_Three::onButtonRB(player* Player)
{
	int num;
	for (int i = 0; i < 4; ++i)
	{
...
void state_Skill_Three::update(player* Player)
{
}
