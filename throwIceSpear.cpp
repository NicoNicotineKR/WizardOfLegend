...
{
	//	원본이미지 넣었다 치고,
	IMAGEMANAGER->addImage("iceSpearDefault", "images/boss/IceBossSkill/iceSpear.bmp", 96, 96, true, 0xFF00FF);
...
void throwIceSpear::render()
{
	...
	//for (int i = 0; i < 36; i++) {
	//	if (i < 12) {
	//		_iceSpearImg[i]->render(getMemDC(), 50 * i + 50, 50);
	//	}
	//	else if (13 <= i && i <= 25) {
	//		_iceSpearImg[i]->render(getMemDC(), 50 * (i-13) + 50, 100);
	//	}
	//	else {
	//		_iceSpearImg[i]->render(getMemDC(), 50 * (i-26) + 50, 150);
	//	}
	//}
